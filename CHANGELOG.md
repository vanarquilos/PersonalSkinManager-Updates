...
### Fixed
- Restored compatibility with the current League version.
- Fixed skin/chroma injection timing and reliability.
- Fixed Reconnect and game-repair issues seen with the previous runtime.
...
- Bundled the required runtime components in the installer.
